    ...
    <div className="flex flex-col-reverse lg:flex-row items-stretch text-center bg-white h-fit w-full max-w-7xl mx-auto">
      ...
      <div className="w-full lg:w-[45%] flex-shrink-0">
        <div className="flex flex-col justify-between w-full bg-yellow-500 border-2 px-[9%] lg:px-[10%] py-[10%] relative text-gray-800 h-[450px] lg:h-[555px]">
          <img src={sideVector.src} alt="" className="lg:block absolute left-0 bottom-0 lg:bottom-10 w-8" />
          <div className="w-full">
            <img src={quoteImage.src} alt="" className="h-4 w-4" />
        ...
        {shouldLoad && isPlaying ? (
          ...
          >
            ...
            <div className="flex flex-col items-center gap-2 relative">
              <div className="w-14 h-14 rounded-full bg-white/95 shadow flex items-center justify-center text-2xl">
                ▶
              </div>
              <div className="text-white text-sm">{shouldLoad ? "Click to play" : "Loading..."}</div>
            </div>
          </button>
        )}
      </div>

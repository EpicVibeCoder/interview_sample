...
/**
 * Testimonials carousel + optional inline video playback.
 *
 * Behavior note: video playback is "clone-aware" because the carousel renders
 * cloned items for infinite scrolling.
 */

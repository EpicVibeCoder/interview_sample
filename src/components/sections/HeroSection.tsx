...
const HeroSection = () => {
  return (
    <section className='relative flex h-screen min-h-[667px] overflow-hidden bg-[#BD1F17] bg-[url("assets/ranges.png")] justify-center items-end lg:items-center bg-repeat bg-[length:100px_100px] pb-8'>
      ...
      <div className="flex max-w-[567px] flex-col lg:flex-row h-[90%] items-center justify-center w-full lg:h-[60%]  lg:w-[80%] px-5 opacity-100 z-10 lg:max-w-[1300px]">
        <div className="text-left flex flex-col lg:w-[40%] justify-around h-[70%]">
          ...
          <a
            href="#menu"
            className="bg-yellow-500 text-black  text-[18px] font-bold leading-[24px] text-center hover:bg-yellow-400 transition w-fit h-[56px] px-6 py-4 gap-2"
          >
            EXPLORE MENU
          </a>
        </div>

...
const AboutSection = () => {
        ...
        About: (
            <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-roboto">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ornare non sed est cursus. Vel hac convallis ipsum, facilisi odio pellentesque bibendum viverra tempus. Lorem ipsum dolor
                    sit amet consectetur adipiscing elit do eiusmod tempor incididunt ut labore et dolore magna minim veniam nostrud exercitation.
                </p>
        ...
        Experience: (
            <div>
                ...
                <p className="text-gray-600 mb-8 leading-relaxed">
                    We have over 50 years of experience in the food industry, providing exceptional dining and fast delivery services. Our team is dedicated to creating the best experiences for our
                    customers.
                </p>
            </div>
        ),
    ...
    // Ref for the section to observe entry/exit
    ...
    // Calculate stroke dash offset for 80%
    // Total circumference for r=50 is 2 * pi * 50 ≈ 314
    // 80% fill means we show 0.8 * 314 = 251.2
    // The offset should be 314 - 251.2 = 62.8
    // But we want to animate TO this value.
    // Initial offset is 314 (empty).
    const fullCircumference = 314;
    const targetOffset = fullCircumference - (percentage * fullCircumference) / 100;
    ...
    return (
        <section id="about" className="bg-white  flex flex-col lg:p-20 lg:px-[10%] relative">
            ...
            <div ref={sectionRef} className="flex flex-col lg:flex-row p-4 xs:p-2">
                {/* Image and Badge */}
                <div className=" w-full justify-items-center lg:w-1/2 p-2">
                    <div className="relative w-full max-w-[674px]">
                        <Image src={burgerImage} alt="Burger" width={674} height={674} sizes="(min-width: 1024px) 50vw, 100vw" className="block w-full h-auto" placeholder="blur" />
                        {/* Badge */}
                        <div
                            className={`absolute top-4 left-4 bg-white p-3 rounded-lg shadow-lg flex items-center w-[200px] font-semibold font-sans transition-transform duration-500 ease-out origin-center ${
                            ...
                            <div className=" w-[50%]  flex items-center justify-center">
                                <svg className="w-full h-full" viewBox="0 0 120 120">
                                    ...
                                    <circle
                                        ...
                                        strokeDashoffset={isVisible ? targetOffset : fullCircumference}
                                        strokeLinecap="round"
                                    ...
                                    <circle
                                        ...
                                        style={{
                                            ...
                                            transform: isVisible ? `rotate(${(percentage * 360) / 100}deg)` : "rotate(0deg)"
                                        }}
                ...
                <div className="w-full lg:w-1/2 p-2">
                    ...
                    {/* 
                                    ...
                                    Keep a consistent height across tabs by overlapping panels in a 1x1 grid.
                                    The grid row height becomes the max of all panels' intrinsic heights.
                              */}
                    <div className="grid w-full pt-10">
                        <div
                            className={`col-start-1 row-start-1 transition-opacity duration-200 ${
                                activeSection === "About" ? "visible opacity-100 pointer-events-auto" : "invisible opacity-0 pointer-events-none"
                            }`}
                        >
                        ...
                        <div
                            className={`col-start-1 row-start-1 transition-opacity duration-200 ${
                                activeSection === "Experience" ? "visible opacity-100 pointer-events-auto" : "invisible opacity-0 pointer-events-none"
                            }`}
                        >
                        ...
                        <div
                            className={`col-start-1 row-start-1 transition-opacity duration-200 ${
                                activeSection === "Contact" ? "visible opacity-100 pointer-events-auto" : "invisible opacity-0 pointer-events-none"
                            }`}
                        >

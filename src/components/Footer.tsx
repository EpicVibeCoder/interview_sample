    ...
    <section className="relative flex justify-center items-center bg-cover bg-center text-white py-10 px-4 bg-[url('./assets/dining.jpeg')] h-fit lg:h-[720px]">
      ...
      <div className="z-10">
        ...
        <div className="flex justify-center space-x-4 mt-20">
          <div className='rounded-full border-white p-3 border-[1px]'><img alt='' src={fb.src} className="h-4 w-4"  /></div>
        
        <div className='rounded-full border-white p-3 border-[1px]'><img alt='' src={twitter.src} className="h-4 w-4"  /></div>
        <div className='rounded-full border-white p-3 border-[1px]'><img alt='' src={insta.src} className="h-4 w-4"  /></div>
        <div className='rounded-full border-white p-3 border-[1px]'><img alt='' src={linked.src} className="h-4 w-4"  /></div>
        </div>

...
const Footer = () => {
    return (
        <section id="footer" className="relative flex justify-center items-center text-white py-10 px-4 h-fit lg:h-[720px] overflow-hidden">
            ...
            <div className="z-10">
                {/* Heading */}
                <h2 className="text-5xl lg:text-7xl font-bebas-neue text-center mb-8">WE are READY TO give YOU THE BEST DINING EXPERIENCE</h2>
                ...
                <div className="flex justify-center items-center space-x-4 mt-20">
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="rounded-full border-white p-3 border-[1px] inline-flex">
                        <Image alt="" src={fb} width={16} height={16} />
                    </a>

                    <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="rounded-full border-white p-3 border-[1px] inline-flex">
                        <Image alt="" src={twitter} width={16} height={16} />
                    </a>

                    <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="rounded-full border-white p-3 border-[1px] inline-flex">
                        <Image alt="" src={insta} width={16} height={16} />
                    </a>
                    <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="rounded-full border-white p-3 border-[1px] inline-flex">

        ...
        About: (
            <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed font-roboto">
                    ...
                    tempor incididunt ut labore et dolore magna minim veniam nostrud exercitation.
                </p>
            ...
            <div className="flex flex-col lg:flex-row p-4 xs:p-2">
                ...
                <div className="w-full lg:w-1/2 p-2">
                    ...
                    <div className="flex space-x-8 border-b border-red-700 ">
                        <button onClick={() => setActiveSection("About")} className={`font-semibold font-inter  ${activeSection === "About" ? "text-white bg-red-700 px-4 py-2" : "text-[#333333] px-4 py-2"}`}>
                            About
                        </button>
                        <button onClick={() => setActiveSection("Experience")} className={`font-semibold font-inter  ${activeSection === "Experience" ? "text-white bg-red-700 px-4 py-2" : "text-[#333333] px-4 py-2"}`}>
                            Experience
                        </button>
                        <button onClick={() => setActiveSection("Contact")} className={`font-semibold font-inter  ${activeSection === "Contact" ? "text-white bg-red-700 px-4 py-2" : "text-[#333333] px-4 py-2"}`}>
                            Contact
                        </button>
                    </div>
